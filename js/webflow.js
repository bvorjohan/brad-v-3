...
! function (t) {
	...
	window.tram = function (t) {
		...
		if (M.transition) {
			var q = M.timing.dom;
			if (S.style[q] = f["ease-in-back"][0], !S.style[q])
				for (var $ in d) f[$][0] = d[$]
		}
		...
		M.transform && (Q.transform = [I], Y = {
			...
			skewX: [k],
			skewY: [k]
		}), M.transform && M.backface && (Y.z = [x, "translateZ"], Y.rotateZ = [k], Y.scaleZ = [w], Y.perspective = [y]);
		var J = /ms/,
			V = /s|\./;
		return t.tram = e
	}(window.jQuery)
	...
	n(4), n(7), n(8), n(9), n(10), t.exports = n(15)
}, function (t, e, n) {
	"use strict";
	var i = n(0);
	...
	r.define("forms", t.exports = function (t, e) {
		...
		function y(e, n) {
			...
			r.handler = null, r.redirect = i.attr("data-redirect"), w.test(s) ? r.handler = E : s || (o ? r.handler = "function" == typeof hostedSubmitWebflow ? hostedSubmitWebflow : O : b())
		}
	...
	i.define("navbar", t.exports = function (t, e) {
		...
		function O(n, r) {
			...
			}(u), u.el.off(p), u.button.off(p), u.menu.off(p), S(u), a ? (z(u), u.el.on("setting" + p, function (t) {
				return function (n, i) {
					i = i || {};
					var r = l.width();
					S(t), !0 === i.open && C(t, !0), !1 === i.open && F(t, !0), t.open && e.defer(function () {
						r !== l.width() && T(t)
					})
				}
			}(u))) : (! function (e) {
		...
		function C(t, e) {
			if (!t.open) {
				t.open = !0, t.menu.each(q), t.links.addClass(b), t.dropdowns.addClass(m), t.dropdownToggle.addClass(g), t.dropdownList.addClass(w), t.button.addClass(v);
				var n = t.config;
		...
		function F(t, e) {
			...
			function u() {
				t.menu.height(""), c(t.menu).set({
					x: 0,
					y: 0
				}), t.menu.each($), t.links.removeClass(b), t.dropdowns.removeClass(m), t.dropdownToggle.removeClass(g), t.dropdownList.removeClass(w), t.overlay && t.overlay.children().length && (x.length ? t.menu.insertAfter(x) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()), t.el.triggerHandler("w-close")
			}
		}
		return u
	})
